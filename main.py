...
def main():
	...
	parser.add_argument("--save_summary_steps", default=20, help="Save summaries every N steps")
	
	parser.add_argument("--checkpoints_save_steps", default=20, help="Save checkpoints every N steps")
